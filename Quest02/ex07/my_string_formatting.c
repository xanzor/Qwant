...
<head data-suburl="">
	...
	<title>quest02_10612_a-8xmt/quest02 - ex07/my_string_formatting.c at dev -  quest02 - git </title>
...
<div class="repository file list ">
		...
		<div class="repo-header">
			...
			<svg viewBox="0 0 16 16" class="svg octicon-lock" width="32" height="32" aria-hidden="true"><path fill-rule="evenodd" d="M4 4v2h-.25A1.75 1.75 0 002 7.75v5.5c0 .966.784 1.75 1.75 1.75h8.5A1.75 1.75 0 0014 13.25v-5.5A1.75 1.75 0 0012.25 6H12V4a4 4 0 10-8 0zm6.5 2V4a2.5 2.5 0 00-5 0v2h5zM12 7.5h.25a.25.25 0 01.25.25v5.5a.25.25 0 01-.25.25h-8.5a.25.25 0 01-.25-.25v-5.5a.25.25 0 01.25-.25H12z"/></svg>
				...
				<div class="repo-buttons">
					<form method="post" action="/quest02_10612_a-8xmt/quest02/action/unwatch?redirect_to=%2fquest02_10612_a-8xmt%2fquest02%2fsrc%2fbranch%2fdev%2fex07%2fmy_string_formatting.c">
					...
					<form method="post" action="/quest02_10612_a-8xmt/quest02/action/star?redirect_to=%2fquest02_10612_a-8xmt%2fquest02%2fsrc%2fbranch%2fdev%2fex07%2fmy_string_formatting.c">
						<input type="hidden" name="_csrf" value="jLA_Suj9_UM0ycRizcTi-JMJZcc6MTU5OTMwOTcyMjE5Nzc2MzMyMg">
						<div class="ui labeled button" tabindex="0">
							<button type="submit" class="ui compact basic button">
	...
	<div class="ui floating filter dropdown custom" data-can-create-branch="false" data-no-results="Результатов не найдено.">
		...
		<div class="data" style="display: none" data-mode="branches">
				...
				<div class="item branch selected" data-url="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c">dev</div>
			
				<div class="item branch " data-url="/quest02_10612_a-8xmt/quest02/src/branch/dev_0/ex07/my_string_formatting.c">dev_0</div>
			
				<div class="item branch " data-url="/quest02_10612_a-8xmt/quest02/src/branch/master/ex07/my_string_formatting.c">master</div>
		...
		<div class="file-header-right">
			<div class="ui right file-actions">
				<div class="ui buttons">
					<a class="ui button" href="/quest02_10612_a-8xmt/quest02/raw/branch/dev/ex07/my_string_formatting.c">Исходник</a>
					
						<a class="ui button" href="/quest02_10612_a-8xmt/quest02/src/commit/2e72fdc63e20518cd2d77fd1c02f7f2664f2f751/ex07/my_string_formatting.c">Постоянная ссылка</a>
					
					
						<a class="ui button" href="/quest02_10612_a-8xmt/quest02/blame/branch/dev/ex07/my_string_formatting.c">Вина</a>
					
					<a class="ui button" href="/quest02_10612_a-8xmt/quest02/commits/branch/dev/ex07/my_string_formatting.c">История</a>
				</div>
					...
					<tbody>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma">
								<code><span class="kt">void</span> <span class="nf">my_string_formatting</span><span class="p">(</span><span class="kt">char</span><span class="o">*</span> <span class="n">firstname</span><span class="p">,</span> <span class="kt">char</span><span class="o">*</span> <span class="n">lastname</span><span class="p">,</span> <span class="kt">int</span> <span class="n">age</span><span class="p">)</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L5" class="lines-code chroma">
								<code>    <span class="n">printf</span><span class="p">(</span><span class="sa"></span><span class="s">&#34;</span><span class="s">Hello, my name is %s %s, I&#39;m %d.</span><span class="s">&#34;</span><span class="p">,</span> <span class="n">firstname</span><span class="p">,</span> <span class="n">lastname</span><span class="p">,</span> <span class="n">age</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
...
function submitDeleteForm() {
	...
	<div class="ui container">
		<div class="ui left">
			Работает на Gitea Версия: 1.13.0&#43;dev-500-g3270e7a44 Страница: <strong>136ms</strong> Шаблон: <strong>98ms</strong>
		</div>
		<div class="ui right links">
			...
			<div class="ui language bottom floating slide up dropdown link item">
				...
				<div class="menu">
						...
						<a lang="en-US" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=en-US">English</a>
					
						<a lang="zh-CN" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=zh-CN">简体中文</a>
					
						<a lang="zh-HK" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=zh-HK">繁體中文（香港）</a>
					
						<a lang="zh-TW" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=zh-TW">繁體中文（台灣）</a>
					
						<a lang="de-DE" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=de-DE">Deutsch</a>
					
						<a lang="fr-FR" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=fr-FR">français</a>
					
						<a lang="nl-NL" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=nl-NL">Nederlands</a>
					
						<a lang="lv-LV" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=lv-LV">latviešu</a>
					
						<a lang="uk-UA" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=uk-UA">Українська</a>
					
						<a lang="ja-JP" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=ja-JP">日本語</a>
					
						<a lang="es-ES" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=es-ES">español</a>
					
						<a lang="pt-BR" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=pt-BR">português do Brasil</a>
					
						<a lang="pt-PT" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=pt-PT">Português de Portugal</a>
					
						<a lang="pl-PL" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=pl-PL">polski</a>
					
						<a lang="bg-BG" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=bg-BG">български</a>
					
						<a lang="it-IT" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=it-IT">italiano</a>
					
						<a lang="fi-FI" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=fi-FI">suomi</a>
					
						<a lang="tr-TR" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=tr-TR">Türkçe</a>
					
						<a lang="cs-CZ" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=cs-CZ">čeština</a>
					
						<a lang="sr-SP" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=sr-SP">српски</a>
					
						<a lang="sv-SE" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=sv-SE">svenska</a>
					
						<a lang="ko-KR" class="item " href="/quest02_10612_a-8xmt/quest02/src/branch/dev/ex07/my_string_formatting.c?lang=ko-KR">한국어</a>
