...
<head data-suburl="">
	...
	<title>quest01_10492_zwhyyu/quest01 - ex01/my_first_variable_integer.c at dev -  quest01 - git </title>
...
<div class="repository file list ">
		...
		<div class="repo-header">
			...
			<svg viewBox="0 0 16 16" class="svg octicon-lock" width="32" height="32" aria-hidden="true"><path fill-rule="evenodd" d="M4 4v2h-.25A1.75 1.75 0 002 7.75v5.5c0 .966.784 1.75 1.75 1.75h8.5A1.75 1.75 0 0014 13.25v-5.5A1.75 1.75 0 0012.25 6H12V4a4 4 0 10-8 0zm6.5 2V4a2.5 2.5 0 00-5 0v2h5zM12 7.5h.25a.25.25 0 01.25.25v5.5a.25.25 0 01-.25.25h-8.5a.25.25 0 01-.25-.25v-5.5a.25.25 0 01.25-.25H12z"/></svg>
				...
				<div class="repo-buttons">
					<form method="post" action="/quest01_10492_zwhyyu/quest01/action/unwatch?redirect_to=%2fquest01_10492_zwhyyu%2fquest01%2fsrc%2fbranch%2fdev%2fex01%2fmy_first_variable_integer.c">
					...
					<form method="post" action="/quest01_10492_zwhyyu/quest01/action/star?redirect_to=%2fquest01_10492_zwhyyu%2fquest01%2fsrc%2fbranch%2fdev%2fex01%2fmy_first_variable_integer.c">
						<input type="hidden" name="_csrf" value="n8TKNW8BZ8Z5xiCyLQUUlFyr1-86MTU5OTIxMjY1NzI0OTQzOTI2NQ">
						<div class="ui labeled button" tabindex="0">
							<button type="submit" class="ui compact basic button">
	...
	<div class="ui floating filter dropdown custom" data-can-create-branch="false" data-no-results="Результатов не найдено.">
		...
		<div class="data" style="display: none" data-mode="branches">
				...
				<div class="item branch selected" data-url="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c">dev</div>
			
				<div class="item branch " data-url="/quest01_10492_zwhyyu/quest01/src/branch/dev_0/ex01/my_first_variable_integer.c">dev_0</div>
			
				<div class="item branch " data-url="/quest01_10492_zwhyyu/quest01/src/branch/master/ex01/my_first_variable_integer.c">master</div>
		...
		<div class="menu transition" :class="{visible: menuVisible}" v-if="menuVisible" v-cloak>
			...
			<div class="message" v-if="showNoResults">${ noResults }</div>
				...
				<div class="fitted item"><span class="ui breadcrumb repo-path"><a class="section" href="/quest01_10492_zwhyyu/quest01/src/branch/dev" title="quest01">quest01</a><span class="divider">/</span><span class="section"><a href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01" title="ex01">ex01</a></span><span class="divider">/</span><span class="active section" title="my_first_variable_integer.c">my_first_variable_integer.c</span></span></div>
		...
		<div class="file-header-right">
			<div class="ui right file-actions">
				<div class="ui buttons">
					<a class="ui button" href="/quest01_10492_zwhyyu/quest01/raw/branch/dev/ex01/my_first_variable_integer.c">Исходник</a>
					
						<a class="ui button" href="/quest01_10492_zwhyyu/quest01/src/commit/69d4eb6ae122e4e8c191941b63d4e62d5a2ea1b8/ex01/my_first_variable_integer.c">Постоянная ссылка</a>
					
					
						<a class="ui button" href="/quest01_10492_zwhyyu/quest01/blame/branch/dev/ex01/my_first_variable_integer.c">Вина</a>
					
					<a class="ui button" href="/quest01_10492_zwhyyu/quest01/commits/branch/dev/ex01/my_first_variable_integer.c">История</a>
				</div>
					...
					<tbody>
						...
						<tr>
							...
							<td rel="L4" class="lines-code chroma">
								<code>  <span class="kt">int</span> <span class="n">person_age</span> <span class="o">=</span> <span class="mi">34</span><span class="p">;</span></code>
							</td>
						</tr>
...
function submitDeleteForm() {
	...
	<div class="ui container">
		<div class="ui left">
			Работает на Gitea Версия: 1.13.0&#43;dev-500-g3270e7a44 Страница: <strong>154ms</strong> Шаблон: <strong>101ms</strong>
		</div>
		<div class="ui right links">
			...
			<div class="ui language bottom floating slide up dropdown link item">
				...
				<div class="menu">
						...
						<a lang="en-US" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=en-US">English</a>
					
						<a lang="zh-CN" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=zh-CN">简体中文</a>
					
						<a lang="zh-HK" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=zh-HK">繁體中文（香港）</a>
					
						<a lang="zh-TW" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=zh-TW">繁體中文（台灣）</a>
					
						<a lang="de-DE" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=de-DE">Deutsch</a>
					
						<a lang="fr-FR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=fr-FR">français</a>
					
						<a lang="nl-NL" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=nl-NL">Nederlands</a>
					
						<a lang="lv-LV" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=lv-LV">latviešu</a>
					
						<a lang="uk-UA" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=uk-UA">Українська</a>
					
						<a lang="ja-JP" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=ja-JP">日本語</a>
					
						<a lang="es-ES" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=es-ES">español</a>
					
						<a lang="pt-BR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=pt-BR">português do Brasil</a>
					
						<a lang="pt-PT" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=pt-PT">Português de Portugal</a>
					
						<a lang="pl-PL" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=pl-PL">polski</a>
					
						<a lang="bg-BG" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=bg-BG">български</a>
					
						<a lang="it-IT" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=it-IT">italiano</a>
					
						<a lang="fi-FI" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=fi-FI">suomi</a>
					
						<a lang="tr-TR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=tr-TR">Türkçe</a>
					
						<a lang="cs-CZ" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=cs-CZ">čeština</a>
					
						<a lang="sr-SP" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=sr-SP">српски</a>
					
						<a lang="sv-SE" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=sv-SE">svenska</a>
					
						<a lang="ko-KR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex01/my_first_variable_integer.c?lang=ko-KR">한국어</a>
