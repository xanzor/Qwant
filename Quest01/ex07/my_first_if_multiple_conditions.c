...
<head data-suburl="">
	...
	<title>quest01_10492_zwhyyu/quest01 - ex07/my_first_if_multiple_conditions.c at dev -  quest01 - git </title>
	<link rel="manifest" href="/manifest.json" crossorigin="use-credentials">
	<meta name="theme-color" content="#6cc644">
	<meta name="author" content="quest01_10492_zwhyyu" />
	<meta name="description" content="quest01" />
	<meta name="keywords" content="go,git,self-hosted,gitea">
	<meta name="referrer" content="no-referrer" />
	<meta name="_csrf" content="n8TKNW8BZ8Z5xiCyLQUUlFyr1-86MTU5OTIxMjY1NzI0OTQzOTI2NQ" />
	...
	<script>
		window.config = {
			...
			csrf: 'n8TKNW8BZ8Z5xiCyLQUUlFyr1-86MTU5OTIxMjY1NzI0OTQzOTI2NQ',
			HighlightJS: false,
			SimpleMDE: false,
			Tribute: false,
			U2F: false,
	...
	<style class="list-search-style"></style>
		...
		<meta property="og:title" content="quest01" />
		<meta property="og:url" content="https://git.us.qwasar.io/quest01_10492_zwhyyu/quest01" />
		
	
	<meta property="og:type" content="object" />
	
		<meta property="og:image" content="https://git.us.qwasar.io/user/avatar/quest01_10492_zwhyyu/-1" />
...
<div class="repository file list ">
	...
	<div class="ui container">
		<div class="repo-header">
			...
			<svg viewBox="0 0 16 16" class="svg octicon-lock" width="32" height="32" aria-hidden="true"><path fill-rule="evenodd" d="M4 4v2h-.25A1.75 1.75 0 002 7.75v5.5c0 .966.784 1.75 1.75 1.75h8.5A1.75 1.75 0 0014 13.25v-5.5A1.75 1.75 0 0012.25 6H12V4a4 4 0 10-8 0zm6.5 2V4a2.5 2.5 0 00-5 0v2h5zM12 7.5h.25a.25.25 0 01.25.25v5.5a.25.25 0 01-.25.25h-8.5a.25.25 0 01-.25-.25v-5.5a.25.25 0 01.25-.25H12z"/></svg>
				...
				<a href="/quest01_10492_zwhyyu">quest01_10492_zwhyyu</a>
				<div class="divider"> / </div>
				<a href="/quest01_10492_zwhyyu/quest01">quest01</a>
				...
				<div class="repo-buttons">
					<form method="post" action="/quest01_10492_zwhyyu/quest01/action/unwatch?redirect_to=%2fquest01_10492_zwhyyu%2fquest01%2fsrc%2fbranch%2fdev%2fex07%2fmy_first_if_multiple_conditions.c">
						<input type="hidden" name="_csrf" value="n8TKNW8BZ8Z5xiCyLQUUlFyr1-86MTU5OTIxMjY1NzI0OTQzOTI2NQ">
						<div class="ui labeled button" tabindex="0">
							...
							<a class="ui basic label" href="/quest01_10492_zwhyyu/quest01/watchers">
								2
							</a>
						</div>
					</form>
					<form method="post" action="/quest01_10492_zwhyyu/quest01/action/star?redirect_to=%2fquest01_10492_zwhyyu%2fquest01%2fsrc%2fbranch%2fdev%2fex07%2fmy_first_if_multiple_conditions.c">
						<input type="hidden" name="_csrf" value="n8TKNW8BZ8Z5xiCyLQUUlFyr1-86MTU5OTIxMjY1NzI0OTQzOTI2NQ">
						<div class="ui labeled button" tabindex="0">
							<button type="submit" class="ui compact basic button">
								<svg viewBox="0 0 16 16" class="svg octicon-star" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25zm0 2.445L6.615 5.5a.75.75 0 01-.564.41l-3.097.45 2.24 2.184a.75.75 0 01.216.664l-.528 3.084 2.769-1.456a.75.75 0 01.698 0l2.77 1.456-.53-3.084a.75.75 0 01.216-.664l2.24-2.183-3.096-.45a.75.75 0 01-.564-.41L8 2.694v.001z"/></svg>В избранное
							</button>
							<a class="ui basic label" href="/quest01_10492_zwhyyu/quest01/stars">
								0
							</a>
						</div>
					</form>
						...
						<div class="ui labeled button " tabindex="0">
							<a class="ui compact basic button " href="/repo/fork/10530" data-position="top center" data-variation="tiny">
								<svg viewBox="0 0 16 16" class="svg octicon-repo-forked" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z"/></svg>Форкнуть
							</a>
							<a class="ui basic label" href="/quest01_10492_zwhyyu/quest01/forks">
								0
							</a>
						</div>
	...
	<div class="ui tabs container">
			...
			<div class="ui tabular stackable menu navbar">
				...
				<a class="active item" href="/quest01_10492_zwhyyu/quest01">
					...
					<a class=" item" href="/quest01_10492_zwhyyu/quest01/pulls">
					...
					<a class=" item" href="/quest01_10492_zwhyyu/quest01/activity">
	...
	<div class="ui floating filter dropdown custom" data-can-create-branch="false" data-no-results="Результатов не найдено.">
		...
		<div class="data" style="display: none" data-mode="branches">
				...
				<div class="item branch selected" data-url="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c">dev</div>
			
				<div class="item branch " data-url="/quest01_10492_zwhyyu/quest01/src/branch/dev_0/ex07/my_first_if_multiple_conditions.c">dev_0</div>
			
				<div class="item branch " data-url="/quest01_10492_zwhyyu/quest01/src/branch/master/ex07/my_first_if_multiple_conditions.c">master</div>
		...
		<div class="menu transition" :class="{visible: menuVisible}" v-if="menuVisible" v-cloak>
			...
			<div class="scrolling menu" ref="scrollContainer">
				...
				<div class="item" v-if="showCreateNewBranch" :class="{active: active == filteredItems.length}" :ref="'listItem' + filteredItems.length">
					...
					<form ref="newBranchForm" action="/quest01_10492_zwhyyu/quest01/branches/_new/branch/dev" method="post">
						<input type="hidden" name="_csrf" value="n8TKNW8BZ8Z5xiCyLQUUlFyr1-86MTU5OTIxMjY1NzI0OTQzOTI2NQ">
			...
			<div class="message" v-if="showNoResults">${ noResults }</div>
				...
				<div class="fitted item"><span class="ui breadcrumb repo-path"><a class="section" href="/quest01_10492_zwhyyu/quest01/src/branch/dev" title="quest01">quest01</a><span class="divider">/</span><span class="section"><a href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07" title="ex07">ex07</a></span><span class="divider">/</span><span class="active section" title="my_first_if_multiple_conditions.c">my_first_if_multiple_condit...</span></span></div>
		...
		<div class="file-header-right">
			<div class="ui right file-actions">
				<div class="ui buttons">
					<a class="ui button" href="/quest01_10492_zwhyyu/quest01/raw/branch/dev/ex07/my_first_if_multiple_conditions.c">Исходник</a>
					
						<a class="ui button" href="/quest01_10492_zwhyyu/quest01/src/commit/69d4eb6ae122e4e8c191941b63d4e62d5a2ea1b8/ex07/my_first_if_multiple_conditions.c">Постоянная ссылка</a>
					
					
						<a class="ui button" href="/quest01_10492_zwhyyu/quest01/blame/branch/dev/ex07/my_first_if_multiple_conditions.c">Вина</a>
					
					<a class="ui button" href="/quest01_10492_zwhyyu/quest01/commits/branch/dev/ex07/my_first_if_multiple_conditions.c">История</a>
				</div>
					...
					<tbody>
						...
						<tr>
							...
							<td rel="L1" class="lines-code chroma">
								<code><span class="cp">#</span><span class="cp">include</span> <span class="cpf">&lt;stdio.h&gt;</span><span class="cp"></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma">
								<code><span class="kt">int</span> <span class="nf">main</span><span class="p">(</span><span class="p">)</span> <span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L4" class="lines-code chroma">
								<code>  <span class="kt">int</span> <span class="n">a</span> <span class="o">=</span> <span class="mi">10</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L5" class="lines-code chroma">
								<code>  <span class="kt">int</span> <span class="n">b</span> <span class="o">=</span> <span class="mi">9</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L6" class="lines-code chroma">
								<code>  <span class="kt">int</span> <span class="n">c</span> <span class="o">=</span> <span class="mi">11</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L7" class="lines-code chroma">
								<code>  <span class="kt">int</span> <span class="n">d</span> <span class="o">=</span> <span class="mi">10</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L8" class="lines-code chroma">
								<code>  <span class="kt">int</span> <span class="n">y</span> <span class="o">=</span> <span class="mi">9</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L9" class="lines-code chroma">
								<code>  <span class="kt">int</span> <span class="n">z</span> <span class="o">=</span> <span class="mi">11</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L11" class="lines-code chroma">
								<code>  <span class="k">if</span> <span class="p">(</span><span class="n">a</span> <span class="o">&gt;</span> <span class="n">b</span> <span class="o">&amp;</span><span class="o">&amp;</span> <span class="n">a</span> <span class="o">&lt;</span> <span class="n">c</span> <span class="o">&amp;</span><span class="o">&amp;</span> <span class="n">a</span> <span class="o">=</span><span class="o">=</span> <span class="n">d</span><span class="p">)</span> <span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L12" class="lines-code chroma">
								<code>    <span class="n">printf</span><span class="p">(</span><span class="sa"></span><span class="s">&#34;</span><span class="s">a is bigger than b AND smaller than c AND equal to d</span><span class="se">\n</span><span class="s">&#34;</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L14" class="lines-code chroma">
								<code>  <span class="k">if</span> <span class="p">(</span><span class="n">z</span> <span class="o">&gt;</span> <span class="n">a</span> <span class="o">|</span><span class="o">|</span> <span class="n">y</span> <span class="o">&gt;</span> <span class="n">a</span><span class="p">)</span> <span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L15" class="lines-code chroma">
								<code>    <span class="n">printf</span><span class="p">(</span><span class="sa"></span><span class="s">&#34;</span><span class="s">z OR y are bigger than a</span><span class="se">\n</span><span class="s">&#34;</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
...
function submitDeleteForm() {
	...
	<div class="ui container">
		<div class="ui left">
			Работает на Gitea Версия: 1.13.0&#43;dev-500-g3270e7a44 Страница: <strong>138ms</strong> Шаблон: <strong>98ms</strong>
		</div>
		<div class="ui right links">
			...
			<div class="ui language bottom floating slide up dropdown link item">
				...
				<div class="menu">
						...
						<a lang="en-US" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=en-US">English</a>
					
						<a lang="zh-CN" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=zh-CN">简体中文</a>
					
						<a lang="zh-HK" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=zh-HK">繁體中文（香港）</a>
					
						<a lang="zh-TW" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=zh-TW">繁體中文（台灣）</a>
					
						<a lang="de-DE" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=de-DE">Deutsch</a>
					
						<a lang="fr-FR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=fr-FR">français</a>
					
						<a lang="nl-NL" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=nl-NL">Nederlands</a>
					
						<a lang="lv-LV" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=lv-LV">latviešu</a>
					
						<a lang="uk-UA" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=uk-UA">Українська</a>
					
						<a lang="ja-JP" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=ja-JP">日本語</a>
					
						<a lang="es-ES" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=es-ES">español</a>
					
						<a lang="pt-BR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=pt-BR">português do Brasil</a>
					
						<a lang="pt-PT" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=pt-PT">Português de Portugal</a>
					
						<a lang="pl-PL" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=pl-PL">polski</a>
					
						<a lang="bg-BG" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=bg-BG">български</a>
					
						<a lang="it-IT" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=it-IT">italiano</a>
					
						<a lang="fi-FI" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=fi-FI">suomi</a>
					
						<a lang="tr-TR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=tr-TR">Türkçe</a>
					
						<a lang="cs-CZ" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=cs-CZ">čeština</a>
					
						<a lang="sr-SP" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=sr-SP">српски</a>
					
						<a lang="sv-SE" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=sv-SE">svenska</a>
					
						<a lang="ko-KR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex07/my_first_if_multiple_conditions.c?lang=ko-KR">한국어</a>
