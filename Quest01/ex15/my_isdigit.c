...
<head data-suburl="">
	...
	<title>quest01_10492_zwhyyu/quest01 - ex15/my_isdigit.c at dev -  quest01 - git </title>
...
<div class="repository file list ">
		...
		<div class="repo-header">
			...
			<svg viewBox="0 0 16 16" class="svg octicon-lock" width="32" height="32" aria-hidden="true"><path fill-rule="evenodd" d="M4 4v2h-.25A1.75 1.75 0 002 7.75v5.5c0 .966.784 1.75 1.75 1.75h8.5A1.75 1.75 0 0014 13.25v-5.5A1.75 1.75 0 0012.25 6H12V4a4 4 0 10-8 0zm6.5 2V4a2.5 2.5 0 00-5 0v2h5zM12 7.5h.25a.25.25 0 01.25.25v5.5a.25.25 0 01-.25.25h-8.5a.25.25 0 01-.25-.25v-5.5a.25.25 0 01.25-.25H12z"/></svg>
				...
				<div class="repo-buttons">
					<form method="post" action="/quest01_10492_zwhyyu/quest01/action/unwatch?redirect_to=%2fquest01_10492_zwhyyu%2fquest01%2fsrc%2fbranch%2fdev%2fex15%2fmy_isdigit.c">
					...
					<form method="post" action="/quest01_10492_zwhyyu/quest01/action/star?redirect_to=%2fquest01_10492_zwhyyu%2fquest01%2fsrc%2fbranch%2fdev%2fex15%2fmy_isdigit.c">
						<input type="hidden" name="_csrf" value="n8TKNW8BZ8Z5xiCyLQUUlFyr1-86MTU5OTIxMjY1NzI0OTQzOTI2NQ">
						<div class="ui labeled button" tabindex="0">
							<button type="submit" class="ui compact basic button">
	...
	<div class="ui floating filter dropdown custom" data-can-create-branch="false" data-no-results="Результатов не найдено.">
		...
		<div class="data" style="display: none" data-mode="branches">
				...
				<div class="item branch selected" data-url="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c">dev</div>
			
				<div class="item branch " data-url="/quest01_10492_zwhyyu/quest01/src/branch/dev_0/ex15/my_isdigit.c">dev_0</div>
			
				<div class="item branch " data-url="/quest01_10492_zwhyyu/quest01/src/branch/master/ex15/my_isdigit.c">master</div>
		...
		<div class="menu transition" :class="{visible: menuVisible}" v-if="menuVisible" v-cloak>
			...
			<div class="message" v-if="showNoResults">${ noResults }</div>
				...
				<div class="fitted item"><span class="ui breadcrumb repo-path"><a class="section" href="/quest01_10492_zwhyyu/quest01/src/branch/dev" title="quest01">quest01</a><span class="divider">/</span><span class="section"><a href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15" title="ex15">ex15</a></span><span class="divider">/</span><span class="active section" title="my_isdigit.c">my_isdigit.c</span></span></div>
		...
		<div class="file-header-right">
			<div class="ui right file-actions">
				<div class="ui buttons">
					<a class="ui button" href="/quest01_10492_zwhyyu/quest01/raw/branch/dev/ex15/my_isdigit.c">Исходник</a>
					
						<a class="ui button" href="/quest01_10492_zwhyyu/quest01/src/commit/69d4eb6ae122e4e8c191941b63d4e62d5a2ea1b8/ex15/my_isdigit.c">Постоянная ссылка</a>
					
					
						<a class="ui button" href="/quest01_10492_zwhyyu/quest01/blame/branch/dev/ex15/my_isdigit.c">Вина</a>
					
					<a class="ui button" href="/quest01_10492_zwhyyu/quest01/commits/branch/dev/ex15/my_isdigit.c">История</a>
				</div>
					...
					<tbody>
						...
						<tr>
							...
							<td rel="L2" class="lines-code chroma">
								<code><span class="kt">int</span> <span class="nf">my_isdigit</span><span class="p">(</span><span class="kt">char</span> <span class="n">param</span><span class="p">)</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L4" class="lines-code chroma">
								<code>    <span class="k">if</span> <span class="p">(</span><span class="n">param</span> <span class="o">&gt;</span><span class="o">=</span> <span class="mi">48</span> <span class="o">&amp;</span><span class="o">&amp;</span> <span class="n">param</span> <span class="o">&lt;</span><span class="o">=</span> <span class="mi">57</span><span class="p">)</span> <span class="p">{</span></code>
							</td>
						</tr>
...
function submitDeleteForm() {
	...
	<div class="ui container">
		<div class="ui left">
			Работает на Gitea Версия: 1.13.0&#43;dev-500-g3270e7a44 Страница: <strong>143ms</strong> Шаблон: <strong>107ms</strong>
		</div>
		<div class="ui right links">
			...
			<div class="ui language bottom floating slide up dropdown link item">
				...
				<div class="menu">
						...
						<a lang="en-US" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=en-US">English</a>
					
						<a lang="zh-CN" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=zh-CN">简体中文</a>
					
						<a lang="zh-HK" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=zh-HK">繁體中文（香港）</a>
					
						<a lang="zh-TW" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=zh-TW">繁體中文（台灣）</a>
					
						<a lang="de-DE" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=de-DE">Deutsch</a>
					
						<a lang="fr-FR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=fr-FR">français</a>
					
						<a lang="nl-NL" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=nl-NL">Nederlands</a>
					
						<a lang="lv-LV" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=lv-LV">latviešu</a>
					
						<a lang="uk-UA" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=uk-UA">Українська</a>
					
						<a lang="ja-JP" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=ja-JP">日本語</a>
					
						<a lang="es-ES" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=es-ES">español</a>
					
						<a lang="pt-BR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=pt-BR">português do Brasil</a>
					
						<a lang="pt-PT" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=pt-PT">Português de Portugal</a>
					
						<a lang="pl-PL" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=pl-PL">polski</a>
					
						<a lang="bg-BG" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=bg-BG">български</a>
					
						<a lang="it-IT" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=it-IT">italiano</a>
					
						<a lang="fi-FI" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=fi-FI">suomi</a>
					
						<a lang="tr-TR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=tr-TR">Türkçe</a>
					
						<a lang="cs-CZ" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=cs-CZ">čeština</a>
					
						<a lang="sr-SP" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=sr-SP">српски</a>
					
						<a lang="sv-SE" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=sv-SE">svenska</a>
					
						<a lang="ko-KR" class="item " href="/quest01_10492_zwhyyu/quest01/src/branch/dev/ex15/my_isdigit.c?lang=ko-KR">한국어</a>
